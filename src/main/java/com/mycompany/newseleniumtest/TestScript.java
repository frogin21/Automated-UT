...
public class TestScript {
    ...
    public String mobile_no;
     ...
     TestScript(String email) {
        ...
        this.nama = "Paijo";
        this.alamat = "JL.galacy RT 10/013";
        this.no_ktp="4807508110056032";
        this.mobile_no="87788334061";
...
//        main.findElement(By.id("ap_dom_address")).sendKeys("domisili selenium"+ this.email, Keys.ENTER);
       ...
       SupportController.waittoLoad(main.findElement(By.id("ap_dom_kab_kot")).findElement(By.cssSelector("option[value='172']")), wait);
       main.findElement(By.id("ap_dom_kab_kot")).sendKeys("Kab. Kulon Progo", Keys.ENTER);
       SupportController.waittoLoad(main.findElement(By.id("ap_dom_kecamatan")).findElement(By.cssSelector("option[value='423']")), wait);
       main.findElement(By.id("ap_dom_kecamatan")).sendKeys("Kalibawang", Keys.ENTER);
       SupportController.waittoLoad(main.findElement(By.id("ap_dom_kelurahan")).findElement(By.cssSelector("option[value='4398']")), wait);
        ...
        */
        ...
        main.findElement(By.id("ap_bank_number")).sendKeys("703919798500");
        ...
        //testcase1
        main.findElement(By.id("ap_monthly_income")).sendKeys("10000000");
        main.findElement(By.id("mainexpenses")).sendKeys("1000000");
...
//      main.click();
    ...
    public void processManager() throws InterruptedException, AWTException {
       ...
       String masukmanager;
        ...
        File file5 = new File("/Users/rahmatzailani/Documents/index.jpg");
        ...
        File file6 = new File("/Users/rahmatzailani/Documents/index.jpg");
        ...
        File file7 = new File("/Users/rahmatzailani/Documents/index.jpg");
